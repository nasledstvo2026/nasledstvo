...
### Правило оформления cron-отчётов (17.07.2026)
- **На КАЖДОЙ странице cron-отчёта ОБЯЗАТЕЛЬНО указывать:**
  - Дату фактического запуска
  - Дату следующего запуска по расписанию
...
- Формат в блоке `<div class="meta">`:
  `📅 Запуск: ДД.ММ.ГГГГ · Следующий запуск: ДД.ММ.ГГГГ (день недели) ЧЧ:ММ`
