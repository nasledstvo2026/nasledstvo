...
- tagline на pharm-tenderolog-product.html заменён на «Ваш цифровой консультант по 44-ФЗ / 224-ФЗ (лекарственные препараты и медизделия)»
...
- Создан health-check: ежедневно 09:00, проверяет валидность zakupki-result.json
