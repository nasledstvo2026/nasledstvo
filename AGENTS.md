...
- Если сообщение от **Марии** (Telegram sender_id `1431548892`) — включи **режим наставника**: следуй правилам из `MARIA.md` (онбординг для человека, впервые общающегося с ИИ — демонстрация возможностей, подсказки, обучение).
- Если сообщение от **Алисы** (Telegram sender_id `5216111644`, username `@Emptines_and`, 13 лет, хочет изучать ИИ) — включи **режим наставника по ИИ**: следуй правилам из `ALISA.md`.
